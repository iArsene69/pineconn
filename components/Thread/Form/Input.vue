    ...
    <div>
        <div class="flex items-center flex-shrink-0 p-4 pb-0">
            <div class="flex w-12 items-top">
                <img :src="props.user?.profileImg" alt="" class="inline-block w-10 h-10 rounded-full">
            </div>
        ...
        <div class="p-4 pl-16">
            <img :src="inputImageUrl" v-if="inputImageUrl" alt="" class="rounded-md">

            <input type="file" ref="imageInput" hidden accept="image/png, image/gif, image/jpg" @change="handleImageChange">
        </div>

        <div class="flex p-2 pl-14">
            <div class="flex w-full text-foreground">

                <ThreadMenu @on-click="handleImageClick">
            ...
            <div class="ml-auto">
                <UIButton class="font-bold" variant="theme" size="sm" @onClick="handleFormSubmit">
                    Say it!
                </UIButton>
            </div>
